...
function Footer()
{
    ...
    <hr className="w-100 clearfix d-md-none"/>
                                ...
                                <p>
                                    <i className="fas fa-home mr-3"></i>gicevafrose@gmail.com</p>
                                <p>
                                    <i className="fas fa-envelope mr-3"></i>dgjorgjievski@gmail.com</p>
                                <p>
                                    <i className="fas fa-phone mr-3"></i>brsjak996@gmail.com</p>
                                <p>
                                    <i className="fas fa-print mr-3"></i>022461765</p>
                                </div>
