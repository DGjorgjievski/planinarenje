      ...
      <div className="card-deck" style={cardStyle}>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Атрактивноста на турата е во врвот, кој има форма на пирамида.
              Љуботен важи за малку суров врв поради тоа што претставува еден
              вид "пристаниште" на Шара каде се прекршуваат сите ветришта.{" "}
            </p>
            <Link to="infoNastan">
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Есента е време кога планината ги покажува сите свои бои.
              Салаковските езера се две глацијални езера на планината Јакупица
              во Македонија кои се наоѓаат на 2180 мнв.
            </p>
            <Link to="infoNastan">
              <button className="btn btn-info" style={btnStyle}>
                Повеќе
      ...
      <div className="card-deck" style={cardStyle}>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              За прв пат јавно организирана акција за масивот Кораб сo
